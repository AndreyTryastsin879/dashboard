...
def get_quantity_of_pages_webmaster_api(user_id, project_yandex_webmaster_host):
    request = requests.get(WEBMASTER_URL_TEMPLATE.format(user_id, project_yandex_webmaster_host), headers=get_auth_headers())
